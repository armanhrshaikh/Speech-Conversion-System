...
try:
    # Specify language as English (United States) and Hindi (India)
    ...
    print("Hindi Iteration:", text_hi)
    result = subprocess.run(["trans", "-b", "-t", "hi", text_en], capture_output=True, text=True)
    print(" ")
    print("Hindi Trans: ", result.stdout)
